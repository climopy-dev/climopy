...
echo '[flake8]'
flake8 climopy docs --exclude .ipynb_checkpoints --max-line-length=88 --ignore=W503,E402,E741

echo '[isort]'
isort --recursive --check-only --line-width=88 --skip __init__.py --multi-line=3 --force-grid-wrap=0 --trailing-comma climopy

# echo '[black]'
# black --check -S climopy
